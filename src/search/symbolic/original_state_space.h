...
class OriginalStateSpace : public SymStateSpaceManager {
  ...
  BDD getPreCondition(int var, int val) const;
 ...
 public:
  ...
  virtual BDD shrinkExists(const BDD &bdd, int) const override { return bdd; }
  virtual BDD shrinkForall(const BDD &bdd, int) const override { return bdd; }
  virtual BDD shrinkTBDD(const BDD &bdd, int) const override { return bdd; }
