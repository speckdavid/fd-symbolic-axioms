...
class TransitionRelation {
    ...
    std::shared_ptr<SymAxiomEvaluator> axiomEvaluator;
    ...
    BDD getPreCondition(const GlobalCondition& cond) const;
public:
    ...
    TransitionRelation(SymVariables *sVars, std::shared_ptr<SymAxiomEvaluator> axiomEvaluator,
