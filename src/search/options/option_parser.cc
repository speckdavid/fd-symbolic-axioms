...
static void get_help(string k) {
    ...
    get_help_templ<shared_ptr<symbolic::SymAxiomEvaluator>>(pt);
    get_help_templ<shared_ptr<symbolic::Stratifier>>(pt);
...
static void get_full_help() {
    ...
    get_full_help_templ<shared_ptr<symbolic::SymAxiomEvaluator>>();
    get_full_help_templ<shared_ptr<symbolic::Stratifier>>();
